...
namespace src.form
{
    public partial class projectfiles : Form
    {
        ...
        private void openFile(file a)
        {
            ...
            closeForm(); 
            mainForm.openEditorForm();
            mainForm.openRawForm();
            mainForm.openWebBrowserForm();
            //mainForm.openPreviewForm(); 
            mainForm.writeContentToRichTextBoxRawForm();
            //mainForm.writeContentToRichTextBoxPreviewForm(); 
        }
