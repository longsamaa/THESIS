...
namespace src.form
{
    ...
    {
        public main main;
        public string text = "Hiển thị các phân đoạn phù hợp về ngữ nghĩa mà bạn đã lưu trong Cơ sở dữ liệu dịch";
        public string type = "Dữ liệu dịch của bạn";
        public string typeOnline = "Dữ liệu dịch của phần mềm"; 
